...
const SheepFarmPage = () => {
  ...
  const product = {
    ...
    sections: [
      {
        heading: "Quality Sheep Farming",
        image: Sheep,
        description: "We are starting a new unit for high-quality farm-raised sheep. Our sheep will be grown naturally with proper care and nutrition to ensure the best stock. Stay tuned for updates on availability!",
      }
    ]
  };
